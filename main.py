...
# pip install onnxruntime numpy librosa torch torchvision torchaudio faster-whisper
...
if __name__ == '__main__':
    model = WhisperModel("tiny", compute_type="int8", device='auto')
    ...
    for segment in segments:
        ...
        # Text
        whisper_result = model.transcribe(segment_samples, language='en')
        text = ' '.join(i.text for i in whisper_result[0])
        segment['text'] = text
